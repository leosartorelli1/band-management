...
class Estilo
{
    ...
    public function inserir()
    {
        ...
        $sql = "INSERT INTO tb_estilos (nomeEstilo, cargaHoraria) VALUES (
             '" . $this->nomeEstilo . "
             )";
        ...
        header("refresh:3; URL=estilos-listar.php");
    }
    ...
    public function excluir()
    {
        ...
        $sql = "DELETE FROM tb_estilos WHERE id=" . $this->id;
        //echo $sql;
        //die();
    ...
    public function carregar()
    {
        ...
        $sql = "SELECT * FROM tb_estilos WHERE id=" . $this->id;
        include "Conexao.php";
        ...
        $this->nomeEstilo = $linha['nomeEstilo'];
    }
    ...
    public function atualizar()
    {
        ...
        $sql = "UPDATE tb_estilos SET 
                    nomeEstilo = '$this->nomeEstilo'
                WHERE id = $this->id ";
